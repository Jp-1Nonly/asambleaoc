...
<head>
    ...
    <meta name="description" content="Error 429 - Too Many Requests)" />
    <meta name="author" content="Your Website" />
    <title>429 Error - {{ config('app.name') }}</title>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-6">
                            <div class="text-center mt-5">
                                ...
                                <p class="lead text-gray-800 mb-5">Demasiadas Solicitudes</p>
                                <p class="text-gray-500 mb-0">Has hecho varios intentos en un corto tiempo</p><br>
