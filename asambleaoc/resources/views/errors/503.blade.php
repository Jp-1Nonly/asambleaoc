...
<head>
    ...
    <meta name="description" content="Error 503 - Service Unavailable" />
    <meta name="author" content="Your Website" />
    <title>503 Error - {{ config('app.name') }}</title>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-6">
                            <div class="text-center mt-5">
                                ...
                                <p class="lead text-gray-800 mb-5">Servicio No Disponible</p>
                                <p class="text-gray-503 mb-0">Estamos trabajando en la solución</p><br>
